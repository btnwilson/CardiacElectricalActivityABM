...
for i in range(50):
    ablated_tissue.insert_pacer_cell(-1,i,20,0)
...
ablated_tissue.tissue[27, 17] = heart_cell(2.1, v_min, v_max, r_h, r_v, 27, 17, .01)
ablated_tissue.tissue[26, 17] = heart_cell(2.1, v_min, v_max, r_h, r_v, 26, 17, .01)
ablated_tissue.tissue[28, 17] = heart_cell(4, v_min, v_max, r_h, r_v, 28, 17, .01)
ablated_tissue.tissue[26, 16] = heart_cell(2.1, v_min, v_max, r_h, r_v, 26, 17, .01)

ablated_tissue.initialize_scar()
t.simulate_tissue(ablated_tissue, 1000000)